...
function loadData(index) {
	...
	var movieName = movies[index].movieName;
	...
	for (var i = 0; i < movies[index].reviews.length; i++) {
		...
		h2.appendChild(document.createTextNode(movies[index].reviews[i].sourceName));
		h3.appendChild(document.createTextNode(movies[index].reviews[i].ratings));
		h3Para.appendChild(document.createTextNode(movies[index].reviews[i].statement));
